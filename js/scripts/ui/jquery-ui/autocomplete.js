...
$(document).ready(function(){
	...
	************************************/
    ...
    $(".ac-remote-datasource").autocomplete({
        source: "data/jquery-ui/search.php",
        minLength: 2
    });
    ...
    $(".ac-remote-caching").autocomplete({
        ...
        source: function(request, response) {
            ...
            $.getJSON("data/jquery-ui/search.php", request, function(data, status, xhr) {
                cache[term] = data;
                response(data);
            });
        }
    ...
    .autocomplete({
        source: function(request, response) {
            $.getJSON("data/jquery-ui/search.php", {
