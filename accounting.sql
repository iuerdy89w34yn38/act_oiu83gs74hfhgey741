...
INSERT INTO `company` (`id`, `comp_name`, `comp_owner`, `comp_phone`, `comp_email`, `comp_address`, `comp_logo`, `floating`, `invformat`) VALUES
...
INSERT INTO `customers` (`id`, `typeid`, `type`, `name`, `mobile`, `company`, `phone`, `email`, `address`, `city`, `country`, `balance`, `dated`, `del`) VALUES
...
INSERT INTO `items` (`id`, `brand`, `name`, `desp`, `price`, `sellprice`, `quantity`, `weight`, `unit`, `stock`, `pause`) VALUES
...
--
-- Dumping data for table `itemu`
--

INSERT INTO `itemu` (`id`, `name`) VALUES
(1, 'Ltr.'),
(2, 'Kg.'),
(3, 'g.');
