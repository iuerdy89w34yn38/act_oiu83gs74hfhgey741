...
("200019","2","Revenue","Sales Account","sales-account","income","30000","1"),
...
("1","4","Test Product 2","test desp","150","200","0","780","120","0"),
...
CREATE TABLE `itemslog` (
  ...
  `datec` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1004008 DEFAULT CHARSET=latin1;
