...
) ENGINE=MyISAM AUTO_INCREMENT=200045 DEFAULT CHARSET=latin1;


INSERT INTO acts VALUES
("200019","2","Revenue","Sales Account","sales-account","income","0","1"),
("200018","10","Cost of Goods Sold","Purchase Account","purchase-account","inventory","3512.5","1"),
...
("1","HP Accounting Software","Hamza Pervaiz","03494965879","hamzapervaiz5@gmail.com","Lahore","","2","1");
...
CREATE TABLE `customers` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=600005 DEFAULT CHARSET=latin1;
...
("5","8","New Stock Product","Sock Product Description","0","0","0","5","Kg.","0","0"),
("3","8","Water Bottle","","70.25","100","0","2","Ltr.","50","0"),
("1","6","Water Bottle","","0","0","0","1.5","Ltr.","0","0"),
("2","7","Water Bottle","","0","0","0","1","Ltr.","0","0"),
("6","7","Red Anar","Red Cold Drink","0","150","0","2.25","Ltr.","200","0"),
("11","8","Khoya ","Ice Cream","0","0","0","100","g.","0","0"),
("12","6","Nido Bunyad","Powder Milk","0","200","0","500","g.","20","0");
...
CREATE TABLE `itemslog` (
  ...
  `datec` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1004028 DEFAULT CHARSET=latin1;


INSERT INTO itemslog VALUES
("1004025","0","6","in","Red Anar","150","200","0","150","2019-09-28"),
("1004026","2005031","3","in","Water Bottle","70.25","50","0","3512.5","2019-09-28"),
("1004027","0","12","in","Nido Bunyad","200","20","0","200","2019-09-28");
...
("1","2005030","200022","0","400009","Vendor Opening Balance of : OpenVend","Vendors","0","100000.50","0","2019-09-28","2019-09-28"),
("2","2005030","10","0","200018","Opening Purchase Account of OpenVend","Cost of Goods Sold","100000.50","0","0","2019-09-28","2019-09-28"),
("3","2005031","200022","0","400008","Goods are Purchased from Test Vendor on Credit Against Invoice No. 987987","Vendors","0","3512.5","3513","2019-09-28","2019-09-28"),
("4","2005031","10","0","200018","Purchase Account","Cost of Goods Sold","3512.5","0","3513","2019-09-28","2019-09-28");
...
CREATE TABLE `transaction` (
  ...
  `dateup` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2005032 DEFAULT CHARSET=latin1;


INSERT INTO transaction VALUES
("2005030","Vendor Opening Balance of : OpenVend","0","","0","0","200018","400009","0","100000.50","2019-09-28","2019-09-28"),
("2005031","Goods are Purchased from Test Vendor on Credit Against Invoice No. 987987","987987","2f3304ea151c414fc4650a269488893d1.png","0","0","200018","400008","3512.5","3512.5","2019-09-28","2019-09-28");
...
CREATE TABLE `vendors` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=400010 DEFAULT CHARSET=latin1;
...
("400008","200022","Vendors","Test Vendor","03232313233","Vend Comp","04234224242","vend@email.com","Al Rehman Garden","Lahore","Pakistan","3513","2019-09-28","0");
