...
("200019","2","Revenue","Sales Account","sales-account","income","32000","1"),
("200018","10","Cost of Goods Sold","Purchase Account","purchase-account","inventory","78000","1"),
("200016","5","Current Assets","Cash in Hands","cash-in-hands","cash","17300","1"),
...
("1","4","Test Product 1","test desp","450","550","0","780","60","0"),
("2","5","Sample Product 2","Test Description","2000","2200","0","10","10","0");
...
CREATE TABLE `itemslog` (
  ...
  `datec` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1004013 DEFAULT CHARSET=latin1;
...
CREATE TABLE `transaction` (
  ...
  `dateup` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2005012 DEFAULT CHARSET=latin1;


INSERT INTO transaction VALUES
("2005003","Cash is Desposited from Capital A/c of Hamza Pervaiz to Cash in Hands","0","","0","0","200042","200016","50000","0","2019-06-24","2019-06-24"),
("2005004","Cash is Desposited fromCapital A/c of Hamza Pervaiz to HBL bank","0","","0","0","200043","200042","25000","25000","2019-06-24","2019-06-24"),
...
("2005007","Goods Sold are sold to Test Customer 4 - Sales Account Credited","0","","0","0","200043","200019","17600","0","2019-06-24","2019-06-24"),
("2005008","Goods Sold are sold to Test Customer 4 - through Cash in Hands","0","","0","0","200016","200019","14400","0","2019-06-24","2019-06-24"),
...
("2005011","Purchase Returned from Test Vendor 1 on Credit Against Invoice No. 980pa78 due to Excess Quantity","980pa78","","0","0","400002","200028","4500","4500","2019-07-03","2019-07-03");
