...
("200018","10","Cost of Goods Sold","Purchase Account","purchase-account","inventory","2553.75","1"),
("200016","5","Current Assets","Cash in Hands","cash-in-hands","cash","47446.25","1"),
...
("600005","200021","Customers","Test Customer","02390239","Comp","","","","Kazi ahmed","Pakistan","0","2019-09-29","0");
...
("3","8","Water Bottle","","0","0","0","2","Ltr.","0","0"),
("1","6","Water Bottle","","0","0","0","1.5","Ltr.","0","0"),
("2","7","Water Bottle","","0","0","0","1","Ltr.","0","0"),
("6","7","Red Anar","Red Cold Drink","0","0","0","2.25","Ltr.","0","0"),
("11","8","Khoya ","Ice Cream","90.25","100","0","100","g.","15","0"),
("12","6","Nido Bunyad","Powder Milk","120","150","0","500","g.","10","0");
...
CREATE TABLE `itemslog` (
  ...
  `datec` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1004031 DEFAULT CHARSET=latin1;
...
CREATE TABLE `transaction` (
  ...
  `dateup` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2005036 DEFAULT CHARSET=latin1;


INSERT INTO transaction VALUES
("2005034","Cash is Desposited from Capital Account to Cash in Hands","0","","0","0","200044","200016","50000","0","2019-10-01","2019-10-01"),
