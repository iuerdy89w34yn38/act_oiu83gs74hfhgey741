...
) ENGINE=MyISAM AUTO_INCREMENT=200033 DEFAULT CHARSET=latin1;
...
CREATE TABLE `journal` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=205654 DEFAULT CHARSET=latin1;
...
CREATE TABLE `ledger` (
  ...
  `dateup` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=760611 DEFAULT CHARSET=latin1;
