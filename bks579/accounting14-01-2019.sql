...
) ENGINE=MyISAM AUTO_INCREMENT=200032 DEFAULT CHARSET=latin1;
...
("200017","5","Current Assets","Cash in Bank","cash-in-bank","cash","20000","0"),
...
("200014","1","Capital","Capital A/c of Hamza Pervaiz","capital-a-c-of-hamza-pervaiz","capital","20000","0"),
...
("200031","4","Expenses","Office Rent","office-rent","expenses","0","0");
...
CREATE TABLE `journal` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=205650 DEFAULT CHARSET=latin1;


INSERT INTO journal VALUES
("205649","Cash is Desposited fromCapital A/c of Hamza Pervaiz to Cash in Bank","200017","200014","20000","20000","2019-01-10","2019-01-10");
...
CREATE TABLE `ledger` (
  ...
  `dateup` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=760602 DEFAULT CHARSET=latin1;


INSERT INTO ledger VALUES
("760600","205649","1","200014","Cash Desposited from Capital A/c of Hamza Pervaiz","Capital","0","20000","20000","2019-01-10","2019-01-10"),
("760601","205649","5","200017","Cash is Coming in Cash in Bank","Current Assets","20000","0","20000","2019-01-10","2019-01-10");
