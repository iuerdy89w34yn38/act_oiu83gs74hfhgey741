...
("200018","10","Cost of Goods Sold","Purchase Account","purchase-account","inventory","35000","1"),
...
("5","8","New Stock Product","Sock Product Description","350","500","0","5","300","0");
...
CREATE TABLE `itemslog` (
  ...
  `datec` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1004022 DEFAULT CHARSET=latin1;


INSERT INTO itemslog VALUES
("1004020","0","5","in","New Stock Product","500","200","0","500","2019-09-22"),
("1004021","2005024","5","in","New Stock Product","350","100","0","35000","2019-09-22");
...
("1","2005024","200022","0","400006","Goods are Purchased from OpenVend on Credit Against Invoice No. ","Vendors","0","35000","35000","2019-09-22","2019-09-22"),
("2","2005024","10","0","200018","Purchase Account","Cost of Goods Sold","35000","0","35000","2019-09-22","2019-09-22");
...
("5","hamza56","admin990","1","2019-06-23","11:54 am","Computer","39.45.129.27","","AS45595 Pakistan Telecom Company Limited","PK","Pakistan","Lahore","Windows 10","Chrome 75.0.3770.100","PC / Laptop","1366x768"),
("6","hamza56","admin990","1","2019-06-24","09:23 am","Computer","119.160.69.118","host-118-net-69-160-119.mobilinkinfinity.net.pk","AS45669 PMCL /LDI IP TRANSIT","PK","Pakistan","Lahore","Windows 10","Chrome 75.0.3770.100","PC / Laptop","1366x768"),
("7","hamza56","admin990","1","2019-06-25","05:06 pm","Computer","39.45.215.77","","AS45595 Pakistan Telecom Company Limited","PK","Pakistan","Lahore","Windows 10","Chrome 75.0.3770.100","PC / Laptop","1366x768"),
("8","hamza56","admin990","1","2019-07-01","12:27 pm","Computer","","","","","","","Windows 10","Chrome 75.0.3770.100","PC / Laptop","1366x768"),
("9","hamza56","admin990","1","2019-07-01","12:27 pm","Computer","","","","","","","Windows 10","Chrome 75.0.3770.100","PC / Laptop","1366x768"),
("10","hamza56","admin990","1","2019-07-03","04:02 pm","Computer","","","","","","","Windows 10","Chrome 75.0.3770.100","PC / Laptop","1366x768"),
("11","hamza56","admin990","1","2019-07-03","04:02 pm","Computer","","","","","","","Windows 10","Chrome 75.0.3770.100","PC / Laptop","1366x768"),
("12","hamza56","admin990","1","2019-07-26","09:21 am","Computer","","","","","","","Windows 10","Chrome 75.0.3770.100","PC / Laptop","1366x768"),
("13","newadmin","newpass","0","2019-07-26","09:21 am","Computer","","","","","","","Windows 10","Chrome 75.0.3770.100","PC / Laptop","1366x768");
...
CREATE TABLE `transaction` (
  ...
  `dateup` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2005025 DEFAULT CHARSET=latin1;


INSERT INTO transaction VALUES
("2005024","Goods are Purchased from OpenVend on Credit Against Invoice No. ","","f5e7c3b6044bfd0755391d559f0486e71.png","0","0","200018","400006","35000","35000","2019-09-22","2019-09-22");
...
CREATE TABLE `users` (
  ...
  `invformat` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;


INSERT INTO users VALUES
("1","hamza56","admin990","admin","4","");
...
("400006","200022","Vendors","OpenVend","","","","","","Islamabad","Pakistan","35000","2019-09-18","0"),
