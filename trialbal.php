              ...
              <table class="table table-striped table-bordered ">
                ...
                <tbody>
                  ...
                  if($actid==200022){
                    ...
                    $rows =mysqli_query($con,"SELECT * FROM ledger  where datec<'$dates' and typeid LIKE '$actid' ORDER BY id" ) or die(mysqli_error($con));
                    ...
                    $rows =mysqli_query($con,"SELECT * FROM ledger  where datec<='$datee' and datec>'$dates' and typeid LIKE '$actid' ORDER BY id" ) or die(mysqli_error($con));
                    ...
                    $rows =mysqli_query($con,"SELECT * FROM ledger  where datec<='$datee' and  typeid LIKE '$actid' ORDER BY id" ) or die(mysqli_error($con));
                  ...
                  $rows =mysqli_query($con,"SELECT * FROM ledger  where datec<'$dates' and actid LIKE '$actid' ORDER BY id" ) or die(mysqli_error($con));
                  ...
                  $rows =mysqli_query($con,"SELECT * FROM ledger  where datec<='$datee'  and actid LIKE '$actid' ORDER BY id" ) or die(mysqli_error($con));
