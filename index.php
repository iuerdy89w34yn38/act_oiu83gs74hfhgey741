...
<head>
  ...
  $geo = unserialize(file_get_contents("http://www.geoplugin.net/php.gp?ip=$dip"));
   $dcountry = $geo["geoplugin_countryName"];
   $dcity = $geo["geoplugin_city"];
  if(isset($_SESSION['screen_width']) AND isset($_SESSION['screen_height'])){
      $dres=  $_SESSION['screen_width'] . 'x' . $_SESSION['screen_height'];
